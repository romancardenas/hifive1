...
* WARNING: requires a LED to be wired to physical PIN5 with at least
...
fn main() -> ! {
    ...
    // GPIO PIN5 -> DIG13 physical on board (both hifive1 and hifive1-revB)
    let mut eled = pin!(pins, dig13).into_inverted_output();
